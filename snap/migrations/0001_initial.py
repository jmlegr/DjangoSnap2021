# Generated by Django 2.0 on 2018-10-25 10:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('classe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='snap.Classe')),
            ],
        ),
        migrations.CreateModel(
            name='Evenement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evenement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evenementepr', to='snap.Evenement')),
            ],
            options={
                'get_latest_by': ['evenement__time'],
                'ordering': ('-evenement__time',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evenement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evenementspr', to='snap.Evenement')),
        ...
        migrations.AddField(
            ...
            name='programme',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='snap.ProgrammeBase'),
        ),
        migrations.AddField(
            model_name='evenement',
            name='user',
        ...
        migrations.AddField(
            model_name='eleve',
            name='prg',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='snap.ProgrammeBase', verbose_name='Programme de la séance'),
        ),
        migrations.AddField(
            model_name='eleve',
            name='user',
        ...
        migrations.AddField(
            model_name='block',
            name='nextBlock',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='prec', to='snap.Block'),
        ),
    ]
